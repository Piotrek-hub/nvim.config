...
_G.packer_plugins = {
  ["lush.nvim"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/lush.nvim",
  ...
  ["packer.nvim"] = {
    ...
    url = "https://github.com/wbthomas/packer.nvim"
  },
  ["plenary.nvim"] = {
    loaded = true,
  ...
  ["vim-tmux-navigator"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/vim-tmux-navigator",
